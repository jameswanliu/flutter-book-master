...
class _ImageProviderResolver {
  ...
  void resolve(CachedNetworkImageProvider provider) {
    ...
    if (_imageStream.key != oldImageStream?.key) {
      oldImageStream?.removeListener(CustomImageStreamListener(_handleImageChanged));
      _imageStream.addListener(CustomImageStreamListener(_handleImageChanged));
    }
  }
  ...
  void stopListening() {
    _imageStream?.removeListener(CustomImageStreamListener(_handleImageChanged));
  }
}

class CustomImageStreamListener extends ImageStreamListener{
  CustomImageStreamListener(onImage) : super(onImage);
}
  ...
  ImageStreamCompleter load(CachedNetworkImageProvider key) {
    return new MultiFrameImageStreamCompleter(
        ...
        informationCollector: () sync* {
          yield DiagnosticsProperty<CachedNetworkImageProvider>(
              'Image provider', this);
          yield DiagnosticsProperty<CachedNetworkImageProvider>(
              'Image key :', key);
        });
